...
export default function ModalActivity({ edit, fetchDataActivity, dataProject }) {
    ...
    return (
        <>
            <div className="flex flex-col w-full max-w-lg bg-white shadow-md rounded px-8 pt-6 pb-8">
                <form method="dialog" className="flex justify-end">
                    <button onClick={() => {
                        setActivity([])
                        setClose(!close)
                    }} className=" bg-white border-0 rounded-full h-6 w-6 shadow-none hover:bg-grey">X</button>
                </form>
                <form method="dialog" className="" onSubmit={edit != "true" ? (e) => submit(e) : (e) => handleEdit(e)}>
                    <div className="flex flex-col gap-4">
                        ...
                        <Button type='submit' color='blue' text={edit != "true" ? "Tambah" : "Edit"}
                        >
                        </Button>
                    </div>
                </form>
